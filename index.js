...
const UUID = process.env.UUID || '9e0da28d-ee9c-4fef-95a4-df2d0335e649'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || '8qpBNXGFJjQlxpbYEL';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
